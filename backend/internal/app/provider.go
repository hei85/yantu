...
// inlineMediaURLFallbackEnabled 打开后，本地单机部署在拿不到公网素材地址时
// 会把参考素材以内嵌 data URL 形式交给上游；协议层已支持 data: 参考素材。
func inlineMediaURLFallbackEnabled() bool {
	return strings.TrimSpace(os.Getenv("CANVAS_INLINE_MEDIA_URLS")) == "1"
}

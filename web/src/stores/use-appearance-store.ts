...
export const DEFAULT_PUBLIC_APPEARANCE: PublicAppearance = {
    ...
    seoTitle: "衍图",
    seoDescription: "衍图，面向 AI 影视与短剧创作的工作台。",
    seoKeywords: "",
    footerCopyright: `© ${new Date().getFullYear()} 衍图. All rights reserved.`,
...
export function brandStudioLabel(appearance: PublicAppearance) {
    if (appearance.brandName === DEFAULT_PUBLIC_APPEARANCE.brandName && appearance.brandSlug === DEFAULT_PUBLIC_APPEARANCE.brandSlug) return "YANTU STUDIO";

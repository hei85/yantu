...
import { autoCanvasAppearance, canvasAppearanceBaseTheme, DEFAULT_CANVAS_BACKGROUND_MODE, normalizeCanvasAppearance, resolveCanvasAppearance, type CanvasAppearance } from "@/lib/canvas/canvas-appearance";
...
export default function SharedCanvasPage() {
    ...
    const [appearance, setAppearance] = useState<CanvasAppearance>(() => autoCanvasAppearance());
    ...
    useEffect(() => {
        ...
        getPublicCanvasShare(token).then(({ project }) => {
            ...
            const nextAppearance = project.appearance ? normalizeCanvasAppearance(project.appearance, themeBeforeShare) : autoCanvasAppearance();
